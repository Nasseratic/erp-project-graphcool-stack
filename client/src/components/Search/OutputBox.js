  ...
  render() {
    return (
        <div className="mycontainer">
            <p className="f-18 semiBold searchHead"><span className="resNo">Displaying results 1-10 out of 2106 for </span><span
                className="country">Egypt</span></p>
            <hr />
            ...
            <div className="pagination flex-wrap justify-content-between text-center">
                <div className="numbers semiBold f-18">
                    <a href="" alt="the alt-text" className="active"><span>1</span></a>
                    <a href="" alt="the alt-text"><span>2</span></a>
                    <a href="" alt="the alt-text"><span>3</span></a>
                    <a href="" alt="the alt-text"><span>4</span></a>
                    <a href="" alt="the alt-text"><span>5</span></a>
                    <a href="" alt="the alt-text"><span>6</span></a>
                </div>
                <div className="prev"><button>PREVIOUS</button></div>
